...
class Interaction:
    ...
    def update(self):
        if collide_check(Obstacle):
            if self.keyboard.left:
                self.obstacle.vel.subtract(Vector(0.1, 0))
            if self.keyboard.right:
                self.obstacle.vel.subtract(Vector(-0.1, 0))
            if self.keyboard.down:
                self.obstacle.vel.subtract(Vector(0, -0.1))
            if self.keyboard.up:
                self.obstacle.vel.subtract(Vector(0, 0.1))
...
class MapInteraction:
    ...
    def update(self):
        if collide_check(Obstacle):
            if self.keyboard.left:
                self.tMap.vel.subtract(Vector(0.1, 0))
            if self.keyboard.right:
                self.tMap.vel.subtract(Vector(-0.1, 0))
            if self.keyboard.down:
                self.tMap.vel.subtract(Vector(0, -0.1))
            if self.keyboard.up:
                self.tMap.vel.subtract(Vector(0, 0.1))
